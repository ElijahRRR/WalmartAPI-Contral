...
| `deleted_items_pt` | 删除历史实证 PT(所有者提议 2026-08-13:walmart_cleanup.error_items 后台删除快照的 product_type = 沃尔玛认定 PT,每 ASIN 折最新一条)——L1 ①b 级第二实证源,与报错日报按时间戳合并 | deleted_pt_import(可重跑 upsert,旧库还在长可定期重导) |
