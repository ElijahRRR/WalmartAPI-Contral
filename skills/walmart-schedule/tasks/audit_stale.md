# 沃尔玛定时任务:audit_stale(每天 16:30,台北时间)

在 `/Users/nextderboy/Projects/WalmartAPI-Contral` 下执行这一行,**原样执行,不要改任何参数**:

```bash
/Users/nextderboy/Projects/WalmartAPI-Contral/.venv/bin/python3 /Users/nextderboy/Projects/WalmartAPI-Contral/cli.py product_audit -p product_audit:mode=stale -p product_audit:limit=2000
```
...
备注:判据提版后的存量消化:approved×旧版本 → 全链重审;候选清零后每轮空转,无需人工停
