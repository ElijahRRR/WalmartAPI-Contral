# 沃尔玛定时任务:backup(每天 02:00,台北时间)

在 `/Users/nextderboy/Projects/WalmartAPI-Contral` 下执行这一行,**原样执行,不要改任何参数**:

```bash
/Users/nextderboy/Projects/WalmartAPI-Contral/.venv/bin/python3 /Users/nextderboy/Projects/WalmartAPI-Contral/cli.py backup
```
...
| 步 | 工作流 | 这一步干什么 |
|---|---|---|
| 1 | `backup` | 中心库 pg_dump 备份(db_schema.md「角色与备份」的落地;批次 A 前置)。 |

备注:pg_dump,离峰;⚠ PATH 里要有 pg_dump
