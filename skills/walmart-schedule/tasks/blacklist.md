# 沃尔玛定时任务:blacklist(每天 15:00,台北时间)
...
备注:黑名单双向同步。**必须排在 product_chain 之后、审核/上架之前**(所有者定稿 2026-08-17):problem_scan 当天产出的黑名单 ASIN 与品牌要立刻投影出去,而审核 Phase0 与上架闸读的是 PG,同步没跑就是拿昨天的黑名单在放行
