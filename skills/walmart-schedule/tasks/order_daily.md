# 沃尔玛定时任务:order_daily(每天 07:30,台北时间)

在 `/Users/nextderboy/Projects/WalmartAPI-Contral` 下执行这一行,**原样执行,不要改任何参数**:

```bash
/Users/nextderboy/Projects/WalmartAPI-Contral/.venv/bin/python3 /Users/nextderboy/Projects/WalmartAPI-Contral/cli.py perf_problems order_asin_normalize -p order_asin_normalize:apply=1
```
